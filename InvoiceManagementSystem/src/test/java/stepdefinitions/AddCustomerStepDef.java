...
public class AddCustomerStepDef extends CommonFunctions {
    ...
    public void iEnterAddressAs(String addressVal) {
        addCustomer.enterAddress(addressVal);

    }

    @When("^I enter city as \"([^\"]*)\"$")
    public void i_enter_city_as(String cityVal) throws InterruptedException {
        Thread.sleep(1000);
    ...
    public void i_click_Add_Customer_Button() throws InterruptedException {
        addCustomer.clickButton();
        Thread.sleep(1000);
    }

    @Then("^I should be able to add new customer into the system$")
    public void iShouldBeAbleToAddNewCustomerIntoTheSystem() {
